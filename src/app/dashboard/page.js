...
export default function AppStoreDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Footer - Diperbaiki seperti di halaman login */}
      <footer className="mt-auto py-4 text-center text-gray-600 text-xs md:text-sm space-y-1 border-t border-gray-300">
        <p>IT Applications Dashboard</p>
        <Link
          href="https://seatrium.com"
          target="_blank"
          className="underline hover:opacity-100 text-gray-600"
        >
          seatrium.com
        </Link>
      </footer>
