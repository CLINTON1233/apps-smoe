...
export default function AdminDashboard() {
  ...
  const getAppIcon = (app) => {
    ...
    return (
      <div
        className={`w-14 h-14 ${defaultColor} rounded-xl flex items-center justify-center text-white font-extrabold text-xl shadow-lg`}
      >
    ...
    <LayoutDashboard>
      <div className="max-w-7xl mx-auto px-4 py-8 relative min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="relative w-full h-full">
            <Image
              ...
              fill
              className="object-contain opacity-3 scale-75" // Opacity 3% untuk efek transparan yang halus
              priority
            />
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          {/* CATEGORY FILTER - WITHOUT CARD WRAPPER */}
          <div className="mb-8">
                  ...
                  >
                    ...
                    <div className="flex justify-between text-xs border-t border-gray-700 pt-3">
                      <span className="flex items-center text-gray-400">
                        <BarChart2 size={12} className="mr-1" /> Downloads:{" "}
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 text-white rounded-xl mt-4 text-xs font-semibold transition-all ${
                        app.file_name
